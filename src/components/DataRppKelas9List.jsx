...
const RppKelas9List = () => {
  ...
  return (
    <div>
      <h1 className="title text-sky-900 ">RPP Kelas 9</h1>
      <h2 className="subtitle">Data Rencana Pencapaian Pembelajaran Kelas 9</h2>
      <Link to="/rppKelas9/add" className="button is-primary mb-2">
        Tambah
      </Link>
